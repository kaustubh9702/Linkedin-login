...
function getAccessToken(){
    ...
    goTo="https://www.linkedin.com/oauth/v2/access_token?client_id=776gr7yjy7wd82"+"&redirect_uri="+redirectURI+"&client_secret="+secret+"&code="+code+"&scope=r_liteprofile%20r_emailaddress";
    console.log(goTo);
